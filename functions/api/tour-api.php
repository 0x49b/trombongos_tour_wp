    ...
    foreach ($categories as $category) {
        ...
        foreach ($events as $event) {
            $event_data = array(
                ...
                'assembly' => tour_format_time($event['assembly']),
                'loadup' => tour_format_time($event['loadup']),
                'departure' => tour_format_time($event['departure']),
                'soundcheck' => tour_format_time($event['soundcheck']),
                'dinner' => tour_format_time($event['dinner']),
                'ending' => tour_format_time($event['ending']),
