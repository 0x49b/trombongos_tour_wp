        ...
        <div class="tour-content-grid">
            ...
            <div>
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <form method="get" action=""
                            ...
                            <noscript><input type="submit" class="button button-small"
                                             value="Filtern" style="width: 100%;"></noscript>
                        </form>
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <p>Verwende diese Shortcodes um die Tourdaten auf der Webseite
                            anzuzeigen:</p>
                        <p><code>[tourdaten]</code><br><small>Zeigt die öffentlichen Tourdaten
                                an</small></p>
