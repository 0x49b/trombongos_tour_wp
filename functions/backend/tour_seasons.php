            ...
            <div class="postbox">
                ...
                <div class="inside">
                    <form method="post" action="">
                        ...
                        <input type="hidden" name="tour_season_action" value="<?php echo $edit_season ? 'edit' : 'add'; ?>">
                        <?php if ($edit_season): ?>
                            <input type="hidden" name="season_id" value="<?php echo esc_attr($edit_season['id']); ?>">
                        <?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description" style="color: #d63638;">
                                        ⚠️ Nur eine Saison kann aktiv sein. Das Aktivieren dieser Saison deaktiviert alle anderen.
                                    </p>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <tr <?php echo $season['active'] ? 'style="background-color: #f0f6fc;"' : ''; ?>>
                                        <td>
                                            ...
                                            <?php if ($season['active']): ?>
                                                <span class="dashicons dashicons-star-filled" style="color: #f0b849;" title="Aktive Saison"></span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <form method="post" style="display: inline;">
                                                    ...
                                                    <button type="submit" class="button button-small" title="Aktivieren">
                                                        Aktivieren
                                                    </button>
                                                </form>
                                            <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <?php if (!$season['active']): ?>
                                                <form method="post" style="display: inline;"
                                                    ...
                                                    <?php wp_nonce_field('tour_season_action'); ?>
                                                    <input type="hidden" name="tour_season_action" value="delete">
                                                    <input type="hidden" name="season_id" value="<?php echo esc_attr($season['id']); ?>">
                                                    <input type="submit"
