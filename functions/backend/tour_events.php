        ...
        <div class="tour-event-form">
            ...
            <form method="post" action="" id="event-form">
                ...
                <input type="hidden" name="tour_event_action"
                       value="<?php echo $edit_event ? 'edit' : 'add'; ?>">
                <?php if ( $edit_event ): ?>
                    <input type="hidden" name="event_id"
                           value="<?php echo esc_attr( $edit_event['id'] ); ?>">
                <?php endif; ?>
                            ...
                            <div class="inside">
                                <table class="form-table">
                                    <tr>
                                        ...
                                        <td><input type="text" name="event_name" id="event_name"
                                                   class="regular-text"
                                                   value="<?php echo $edit_event ? esc_attr( $edit_event['name'] ) : ''; ?>"
                                                   required></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select name="category_id" id="category_id"
                                                ...
                                                foreach ( $categories as $cat ):
                                                    ...
                                                    ?>
                                                    <option value="<?php echo esc_attr( $cat['id'] ); ?>" <?php if ( $edit_event ) {
                                                        selected( $edit_event['category_id'], $cat['id'] );
                                                    } ?>>
                                        ...
                                        <td>
                                            <select name="day" id="day" required>
                                                <?php foreach ( $days as $idx => $day_name ): ?>
                                                    <option value="<?php echo $idx; ?>" <?php if ( $edit_event ) {
                                                        selected( $edit_event['day'], $idx );
                                                    } ?>>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="sort" id="sort" min="0"
                                                   value="<?php echo $edit_event ? esc_attr( $edit_event['sort'] ) : '0'; ?>">
                                            <p class="description">Für gleiche Tage - kleinere
                                                Zahlen zuerst</p>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div class="inside">
                                <table class="form-table">
                                    <tr>
                                        ...
                                        <td><input type="text" name="organizer" id="organizer"
                                                   class="regular-text"
                                                   value="<?php echo $edit_event ? esc_attr( $edit_event['organizer'] ) : ''; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="location" id="location"
                                                   class="regular-text"
                                                   value="<?php echo $edit_event ? esc_attr( $edit_event['location'] ) : ''; ?>">
                                            <div id="maps-preview"
                                                 style="margin-top: 8px; display: none;">
                                                <a href="#" target="_blank" id="maps-link"
                            ...
                            <div class="inside">
                                <table class="form-table">
                                    <tr>
                                        ...
                                        <td><input type="time" name="play" id="play"
                                                   value="<?php echo $edit_event ? esc_attr( $edit_event['play'] ) : ''; ?>"
                                                   required></td>
                                    </tr>
                                    <tr>
                                        <th><label for="gathering">Besammlung</label></th>
                                        <td><input type="time" name="gathering" id="gathering"
                                                   value="<?php echo $edit_event ? esc_attr( $edit_event['gathering'] ) : ''; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th><label for="makeup">Schminken</label></th>
                                        <td><input type="time" name="makeup" id="makeup"
                                                   value="<?php echo $edit_event ? esc_attr( $edit_event['makeup'] ) : ''; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th><label for="warehouse">Magazin</label></th>
                                        <td><input type="time" name="warehouse" id="warehouse"
                                                   value="<?php echo $edit_event ? esc_attr( $edit_event['warehouse'] ) : ''; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th><label for="sun">Sonne</label></th>
                                        <td><input type="time" name="sun" id="sun"
                                                   value="<?php echo $edit_event ? esc_attr( $edit_event['sun'] ) : ''; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <table class="form-table">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="trailer" id="trailer"
                                                   class="regular-text"
                                                   placeholder="Wer bringt den Anhänger?"
                                                   value="<?php echo $edit_event ? esc_attr( $edit_event['trailer'] ) : ''; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="inside">
                                <table class="form-table">
                                    <tr>
                                        <th>Status</th>
                                        <td>
                                            <label><input type="checkbox" name="fix"
                                                          value="1" <?php if ( $edit_event ) {
                                                    checked( $edit_event['fix'], 1 );
                                                } ?>> <strong>Bestätigt (Fix)</strong></label>
                                            <p class="description">Nur bestätigte Auftritte
                                                erscheinen in der API</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Sichtbarkeit</th>
                                        <td>
                                            <label><input type="checkbox" name="public"
                                                          value="1" <?php if ( $edit_event ) {
                                                    checked( $edit_event['public'], 1 );
                                                } ?>> <strong>Öffentlich</strong></label>
                                            <p class="description">Auf öffentlicher Website
                                                anzeigen</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <textarea name="info" id="info" rows="4"
                                                      class="large-text"><?php echo ( $edit_event && $edit_event['info'] ) ? esc_textarea( $edit_event['info'] ) : ''; ?></textarea>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                ...
                <p class="submit">
                    ...
                    <a href="<?php echo admin_url( 'admin.php?page=tour_events' ); ?>"
                       class="button button-large">Abbrechen</a>
                </p>
            </form>
        </div>
        ...
        <div class="tablenav top">
            <form method="get" action=""
                ...
                <select name="filter_status">
                    ...
                    <option value="fix" <?php selected( $filter_status, 'fix' ); ?>>Bestätigt
                    </option>
                    <option value="not_fix" <?php selected( $filter_status, 'not_fix' ); ?>>Nicht
                        bestätigt
                    </option>
                    <option value="public" <?php selected( $filter_status, 'public' ); ?>>
                        Öffentlich
                    </option>
                    <option value="private" <?php selected( $filter_status, 'private' ); ?>>Privat
                    </option>
                </select>
